...
name: researcher
description: >
  Elite AI/ML verification researcher. Delegates to this agent when the architecture document contains ML components (PyTorch, TensorFlow, or similar). Validates tensor shapes, VRAM budgets, and framework APIs; implements core ML modules; produces Pydantic v2 I/O schemas. Always invoked after Designer and before Developer on ML-bearing features.
