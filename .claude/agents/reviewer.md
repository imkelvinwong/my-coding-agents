...
name: reviewer
description: >
   Senior code reviewer and quality gate. Delegates to this agent to inspect the Developer's implementation against both specification documents before any build is attempted. Produces decision_code: APPROVED or REJECTED in md_docs/reviewer/active/<FEATURE_NAME>_REVIEW_CYCLE_N.md.
tools: Read, Grep, Glob, WebFetch, TodoRead, TodoWrite
model: sonnet
skills:
