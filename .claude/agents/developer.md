...
name: developer
description: >
   Expert software engineer and implementation lead. Delegates to this agent to translate architecture and design specifications into production-ready source code. Invoked by the Orchestrator after the Reviewer approves a round-trip or after a design/architecture document is produced.
tools: Read, Grep, Glob, Edit, Write, WebFetch, TodoRead, TodoWrite
model: sonnet
skills:
