...
name: designer
description: >
  Expert product designer. Delegates to this agent to produce the design specification (md_docs/designer/active/<FEATURE_NAME>_DESIGN.md) after the Orchestrator's UI Scope Gate classifies the feature as UI_REQUIRED. Skipped when the Orchestrator writes a Non-UI Waiver.
