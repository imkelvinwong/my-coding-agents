...
name: tester
description: >
  Expert QA engineer and test lead. Delegates to this agent after the Builder Completion Report reads "Ready for Tester: Yes". Derives a complete test plan, generates tests (sequential or Fan-Out parallel depending on target count), executes them, classifies failures, self-remediates where permitted, and produces status_code: PASSING or BLOCKED.
tools: Bash, Read, Grep, Glob, Edit, Write, WebFetch, TodoRead, TodoWrite
model: sonnet
skills:
